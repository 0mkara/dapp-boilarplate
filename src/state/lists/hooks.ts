...
export function useUnsupportedTokenList(): TokenAddressMap {
  ...
  const brokenListMap = useMemo(() => tokensToChainTokenMap(BROKEN_LIST as TokenList), [])

  // get hard-coded list of unsupported tokens
  const localUnsupportedListMap = useMemo(() => tokensToChainTokenMap(UNSUPPORTED_TOKEN_LIST as TokenList), [])
