...
interface IUniswapV3StakerInterface extends ethers.utils.Interface {
  functions: {
...
export type IncentiveEndedEvent = TypedEvent<
  [string, BigNumber] & { incentiveId: string; refund: BigNumber }
>;

export type RewardClaimedEvent = TypedEvent<
  [string, BigNumber] & { to: string; reward: BigNumber }
>;
...
export type TokenUnstakedEvent = TypedEvent<
  [BigNumber, string] & { tokenId: BigNumber; incentiveId: string }
>;

export class IUniswapV3Staker extends BaseContract {
